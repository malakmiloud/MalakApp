    ...
    public partial class CustomerInsert : Form
    {
        ...
        private void submitButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (i != 0)
                {
                    MessageBox.Show("عملية إضافة زبون تمت بنجاح", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("فشلت عملية اضافة الزبون", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
