...
namespace MalakApp
{
    public partial class ProductDelete : Form
    {
        ...
        private void Searchbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("لا يوجد منتج بهذا الرقم", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Deletebtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (i != 0)
                {
                    MessageBox.Show("تمت عملية حذف المنتج بنجاح", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("فشلت عملية حذف المنتج", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                ProductName.Clear();
                ProductID.Clear();
            }
