...
namespace MalakApp
{
    public partial class CustomerDelete : Form
    {
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("زبون غير موجود", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                if(con != null)
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (i != 0)
                {
                    MessageBox.Show("تم حذف الزبون بنجاح", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("فشلت عملية حذف الزبون", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            ...
            {
                MessageBox.Show("الزبون غير موجود", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
