    ...
    public partial class ProductInsert : Form
    {
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (i != 0)
                {
                    MessageBox.Show("تمت عملية إضافة منتج بنجاح", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                else
                {
                    MessageBox.Show("فشلت عملية اضافة المنتج", "Captions", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
